  ...
  return (
    <WebLayout>
      <div className="min-h-screen bg-gray-50 pb-24 md:pb-0">
        ...
        {/* Goal Cards */}
        <div className="px-6 pb-6 pt-6 bg-gray-50 mt-0">
            ...
            <div>
              ...
              <div className="flex items-center gap-3">
                <input
                  ...
                  className="flex-1 bg-gray-50 rounded-2xl px-5 py-4 text-2xl font-bold border-2 border-transparent focus:border-purple-600 outline-none text-center"
                />
        ...
        {/* Additional Goals */}
        <div className="px-6 pb-2 text-left bg-gray-50">
        ...
        {/* Save Button */}
        <div className="px-6 pt-2 pb-8 bg-gray-50">
          <button 
